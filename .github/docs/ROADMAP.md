...
Última revisión completa: 2026-08-21.
...
- [ ] **Transición de tema que revele el contenido real, no un disco opaco** — el
      ...
      **Archivos:** `components/ThemeRevealOverlay.tsx:129-146` (hoy pinta un
...
Sin entradas pendientes: la revisión del 2026-08-21 fundió "Datos" y "Cuenta y
nube" en una sola pantalla, sacó el perfil público a Comunidad y quitó los
rótulos duplicados. Ver [UPDATES.md](UPDATES.md).
...
- [ ] **Registrar un ejercicio no planificado durante la sesión** — hoy el
      ...
      **Archivos:** `features/workout/WorkoutLogScreen.tsx:1146` (el registro
...
- [ ] **Exportar CSV además de JSON** — para abrir el historial en Excel.
      ...
      **Archivos:** `lib/fileIO.ts` (`downloadJsonFile` como patrón; nueva
      ...
      `features/workout/DataScreen.tsx:475-495` (botón nuevo junto a Exportar,
